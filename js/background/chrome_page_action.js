...
/**
 * Manager of chrome.action things
 * 
...
class ChromePageAction {
  ...
  /**
   * Sets the title of the action. This is displayed in a tooltip over the toolbar icon.
   * 
   ...
   * @prop {number} [tabId] - (override) The id of the tab for which you want to modify the action.
  ...
  /**
   * Sets the icon for the action. The icon can be specified either as the path to an image file or as the pixel 
  ...
  setIcon(details) {
    return new Promise(resolve => {
      chrome.action.setIcon(Object.assign({tabId: this.tabId}, details), () => resolve())
    })
  }

  /**
   * Enables or disables the action to mirror the old page-action visibility state.
   * 
